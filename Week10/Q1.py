...
# Complete add_credential(website, username, password)
#   Connect to DB_NAME.
#   INSERT a row into vault with: website, username, password.
#   Commit and close the connection.
def add_credential(website, username, password):
    # sqlite3 is a built-in package
    conn = sqlite3.connect(DB_NAME) # you can use a global name storing your db
    cursor = conn.cursor()
    cursor.execute(
...
# Complete find_credential(website)
#   Connect to DB_NAME.
